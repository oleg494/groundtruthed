...
`analysis/api_method_names_validate.py` · READ-ONLY · офлайн · оракул = `docs/official/contracts/*.proto`.

- proto-файлов: **9**, объявлено RPC: **107**
- просканировано `.py` (scripts/ + analysis/): **83**, уникальных вызванных RPC: **38**

## ✓ Результат

**Phantom-методов не найдено.** Все 38 уникальных RPC, вызванных в коде, объявлены в proto. Класс багов «вызов несуществующего метода» отсутствует.
